...
BEGIN
   CALL reports.create_intercam(target_bandeira_visa, target_tpv_visa, target_qtd_visa);
   CALL reports.create_intercam(target_bandeira_mc, target_tpv_mc, target_qtd_mc);
   CALL reports.create_intercam(target_bandeira_elo, target_tpv_elo, target_qtd_elo);
