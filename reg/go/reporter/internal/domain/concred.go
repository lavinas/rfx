...
type Conccred struct {
	...
	Brand                      int64   `fixed:"6,7" gorm:"column:brand"`
	Function                   string  `fixed:"8,8" gorm:"column:function"`
	CredentialedEstablishments int64   `fixed:"9,17" gorm:"column:number_accredited_establishments"`
	ActiveEstablishments       int64   `fixed:"18,26" gorm:"column:number_active_establishments"`
	TransactionValue           float64 `gorm:"column:transaction_amount"`
	TransactionValueInt        int64   `fixed:"27,41"`
	TransactionQuantity        int64   `fixed:"42,53" gorm:"column:transaction_quantity"`
}
