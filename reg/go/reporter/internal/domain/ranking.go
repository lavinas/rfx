...
type Ranking struct {
	...
	ClientCode   string  `fixed:"6,13" gorm:"column:establishment_code"`
	Function     string  `fixed:"14,14" gorm:"column:function"`
	Brand        int64   `fixed:"15,16" gorm:"column:brand"`
	Capture      int64   `fixed:"17,17" gorm:"column:capture_mode"`
	Installments int64   `fixed:"18,19" gorm:"column:installments"`
	Segment      int64   `fixed:"20,22" gorm:"column:segment_code"`
	Value        float64 `gorm:"column:transaction_amount"`
	ValueInt     int64   `fixed:"23,37"`
	Qtty         int64   `fixed:"38,49" gorm:"column:transaction_quantity"`
	Discount     float64 `gorm:"column:avg_mcc_fee"`
