...
type Infrterm struct {
	...
	TotalPOSCount      int64  `fixed:"8,15" gorm:"column:pos_total_quantity"`
	SharedPOSCount     int64  `fixed:"16,23" gorm:"column:pos_shared_quantity"`
	ChipReaderPOSCount int64  `fixed:"24,31" gorm:"column:pos_chip_quantity"`
	PDVCount           int64  `fixed:"32,39" gorm:"column:pdv_quantity"`
}
