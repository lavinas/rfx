...
type Infresta struct {
	...
	UF                string `fixed:"6,7" gorm:"column:federation_unit"`
	TotalCli          int64  `fixed:"8,15" gorm:"column:establishment_total_quantity"`
	TotalCliManual    int64  `fixed:"16,23" gorm:"column:establishment_manual_capture_quantity"`
	TotalCliEletronic int64  `fixed:"24,31" gorm:"column:establishment_eletronic_capture_quantity"`
	TotalCliRemote    int64  `fixed:"32,39" gorm:"column:establishment_remote_capture_quantity"`
}
...
func (r *Infresta) LoadInfrestaFile(file *bufio.Scanner) ([]*Infresta, error) {
...
func (r *Infresta) GetParsedFile(file *bufio.Scanner) (map[string]port.Report, error) {
	fileInfresta, err := r.LoadInfrestaFile(file)
	if err != nil {
		return nil, err
	}
